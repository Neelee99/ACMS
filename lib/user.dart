...
class ManageCards1 extends StatelessWidget {
 ...
 bool validate() {
  ...
  Stream<QuerySnapshot> getUsersTripsStreamSnapshots1(BuildContext context) async* {
    ...
    yield* Firestore.instance.collection('shops').document(sid).collection('vegetables').snapshots();
    //print()
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(children: <Widget>[
                  Text("Shop Name: "+card['vege_name'], style: new TextStyle(fontSize: 20.0),),
                  Spacer(),
                ]),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 8.0, bottom: 4.0),
                child: Row(children: <Widget>[
                  Text("Shop Expiry: "+card['vege_quantity'], style: new TextStyle(fontSize: 20.0),),
                  Spacer(),
                ]),
              ),
